...
export default function AddGatepass() {
  // State variables
  const [gatepass_file, setGatepassFile] = useState(null);
  ...
  function HandleForm(e) {
    ...
    data.append("image", gatepass_file);
    ...
    <>
      ...
      <div className="d-flex justify-content-center align-items-center min-vh-100">
        ...
        <div className="card shadow-lg p-4 rounded-3" style={{ maxWidth: "500px", width: "100%" }}>
          <h2 className="text-center text-primary">Add Gatepass</h2>
          ...
          <form onSubmit={HandleForm} className="py-4">
            ...
            <div className="form-floating mb-3">
              <input
                ...
                id="gatepass_file"
                accept=".pdf, .jpg, .png"
                onChange={(e) => setGatepassFile(e.target.files[0])}
              />
