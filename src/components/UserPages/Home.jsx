                  ...
                  <div className="row justify-content-center align-items-center">
                    <div className="col-lg-10 text-center">
                      ...
                      {token ? (
                        ...
                        // <Link to="/login" >
                        //   <h4 className=" btn btn-primary rounded-pill text-white animated slideInDown fst-italic text-decoration-underline ">Join Us</h4>
                        // </Link>
                        <Link
                          to="/login"
                          className="btn btn-primary px-4 py-2 rounded-pill text-white animated slideInDown fw-bold shadow-lg border-0"
                          style={{
                            background: "linear-gradient(135deg,rgb(196, 228, 251) 0%, rgb(63, 178, 209)100%)",
                            fontSize: "1.1rem",
                            textDecoration: "none",
                          }}
                        >
